...
/**
 * Test script for parsing Novo Nordisk annual reports
 * Usage: npm run test:parse:novonordisk
 */
...
const COMPANY_CODE = "novonordisk";

async function testNovoNordiskParse() {
  try {
    console.log("🧪 Testing Novo Nordisk Financial Statement Parsing");
...
if (require.main === module) {
  testNovoNordiskParse();
}

export { testNovoNordiskParse };
