...
/**
 * Test script for parsing Stellantis annual reports
 * Usage: npm run test:parse:stellantis
 */
...
const COMPANY_CODE = "stellantis";

async function testStellantisParse() {
  try {
    console.log("🧪 Testing Stellantis Financial Statement Parsing");
